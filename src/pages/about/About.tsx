      ...
      <Composition.section>
        ...
        <div className="   flex flex-col bg-bac  max-lg:w-[90%] ">
          ...
          <p className={"text-white font-light mt-6 text-[20px] "}>
            ...
            Inicialmente, tinha interesse em entender o mundo dos hackers e a
            exploração de vulnerabilidades, o que despertou meu interesse por
            programação. Comecei estudando C++, mesmo sem ter um computador, e
            depois migrei para Python, aprendendo principalmente pelo celular,
            através de vídeos no YouTube , como os do Gustavo Guanabara. Com o
            tempo, descobri o desenvolvimento web, área pela qual me apaixonei,
            junto com o interesse por UI Design.
            <br />
